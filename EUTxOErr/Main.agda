...
-- open import EUTxOErr.Example

-- ** An example of using separation logic to detect and mitigate "double-satisfaction" bugs.
open import EUTxOErr.DoubleSatisfaction
