module ValueSepExact.Main where
...
-- We model the ledger state as maps from participants to balances, using a concrete map implementation in ValueSepExact.Maps,
...
open import ValueSepExact.Ledger
...
open import ValueSepExact.HoareLogic
open import ValueSepExact.HoareProperties
