module ValueSepSimple.Main where
...
-- We model the ledger state as maps from participants to balances, using a concrete map implementation in ValueSepSimple.Maps,
...
open import ValueSepSimple.Ledger
...
open import ValueSepSimple.HoareLogic
open import ValueSepSimple.HoareProperties
...
open import ValueSepSimple.CSL
...
open import ValueSepSimple.Example
