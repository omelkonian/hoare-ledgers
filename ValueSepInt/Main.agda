...
-- We model the ledger state as maps from participants to balances, using a concrete map implementation in ValueSepInt.Maps,
...
open import ValueSepInt.Ledger
...
open import ValueSepInt.HoareLogic
open import ValueSepInt.HoareProperties
...
open import ValueSepInt.Example
